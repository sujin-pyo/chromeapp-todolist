...
var API_KEY = "3cdf0c30e65f4a2f430f423bd6365537";
...
function onGeoOk(position) {
  ...
  fetch(url).then(function (response) {
    ...
    weather.innerText = "".concat(data.weather[0].main, " / ").concat(data.main.temp, "\xB0C / ").concat(data.name);
    weatherImg.src = "http://openweathermap.org/img/wn/".concat(data.weather[0].icon, "@2x.png");
  });
}
function onGeoError() {
